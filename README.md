# Project Assignment for the course Back End Programming - SOF003AS3AE-3006
Project topic is an application for personal accounting
...
- Project can be found from GitHub (done)
- Project is deployed to some server in the internet (done, deployed on Heroku, see the link above)
